...
public class DataGenerator {
    ...
    public static String generateCity() {
        var cities = new String[]{"Майкоп", "Горно-алтайск", "Уфа", "Улан-уде", "Махачкала", "Магас", "Нальчик",
                "Элиста", "Черкеск", "Петрозаводск", "Сыктывкар", "Симферополь", "Йошкар-Ола", "Саранск",
                "Якутск", "Владикавказ", "Казань", "Кызыл", "Ижевск", "Абакан", "Грозный", "Чебоксары",
                "Барнаул", "Чита", "Петрозаводск-Камчатский", "Краснодар", "Красноярск", "Пермь",
                ...
                "Ярославль", "Севастополь", "Биробеджан", "Нарьян-Омар", "Ханты-Мансийск", "Анадырь"};
